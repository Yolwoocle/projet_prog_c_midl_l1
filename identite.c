...
#define FORMAT_DATE_CHIFFRE_MAX 2 // Nombre de chiffres du format date (avec un format "%30s" par exemple cette valeur sera 2)
#define FORMAT_FICH_CHIFFRE_MAX 3
